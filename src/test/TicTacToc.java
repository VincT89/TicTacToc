...
public class TicTacToc {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TicTacToc window = new TicTacToc();
	...
	private void winningGame() {
		//per il player X
		 if(b1 == 1 && b2 == 1 && b3 == 1) {
			 JOptionPane.showMessageDialog(frame, "Player X Vince", "Tic Tac Toc", JOptionPane.INFORMATION_MESSAGE);
			 xCount1++;
		 ...
		 //per il player O
			 ...
			 JOptionPane.showMessageDialog(frame, "Player O Vince", "Tic Tac Toc", JOptionPane.INFORMATION_MESSAGE);
			 oCount1++;
			 ...
			 JOptionPane.showMessageDialog(frame, "Nessun Vincitore", "Tic Tac Toc", JOptionPane.INFORMATION_MESSAGE);
		 }
	}
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn2.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn3.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn4.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn5.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn6.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn7.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn8.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btn9.setFont(new Font("Tahoma", Font.BOLD, 76));
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Confermi di voler uscire?","Tic Tac Toc", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
			}
		});
